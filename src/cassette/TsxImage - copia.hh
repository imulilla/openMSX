...
{
public:
	TsxImage(const Filename& fileName, FilePool& filePool, CliComm& cliComm,std::string IPSI);
...
private:
	...
	void convert(const Filename& filename, FilePool& filePool, CliComm& cliComm,std::string IPSI);
